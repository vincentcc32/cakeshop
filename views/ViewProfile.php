                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4 mb-xl-0">
                                ...
                                <div class="card-body text-center d-flex flex-column align-items-center justify-content-center gap-2">
                                    ...
                                    <input type="file" id="inputavt" name="avt" accept="image/*" hidden>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="d-flex gap-4">
                                                ...
                                                <?= $item['MaXacNhanCK'] !== null && $item['TrangThai'] === 0 ? '<span class="fs-4 text-danger">Chờ xác nhận chuyển khoản</span>' : ($item['MaXacNhanCK'] !== null && $item['TrangThai'] === 1 ? '<span class="fs-4 text-success">Chuyển khoản thành công</span>' : '') ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 fs-4"><?= $item['TrangThai'] === 0 ? '<span class="fs-4 text-danger">Chưa thanh toán</span>' : '<span class="fs-4 text-success">Đã thanh toán</span>' ?></div>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
